...
public class rotateMatrix_faulty {
    ...
    public static List<List<Integer>> findMatrix(int N, List<List<Integer>> A) {
        List<List<Integer>> res = DeepCopy(A);
        System.out.println("res"+res);
        insertNewMatrixWithOnes(res,A);
        List<List<Integer>> r1  = DeepCopy(rotateMatrixBy90(res));
        insertNewMatrixWithOnes(res,r1);
        List<List<Integer>> r2  = DeepCopy(rotateMatrixBy90(r1));
        insertNewMatrixWithOnes(res,r2);
        List<List<Integer>> r3  = DeepCopy(rotateMatrixBy90(r2));
        insertNewMatrixWithOnes(res,r3);
        return res;
    }
